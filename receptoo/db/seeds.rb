...
Recipe.create(title: "Tomato Chicken Whatever", description: "Cook erverthing well", duration: 20, difficulty: 3, rating: 2, creator_name: "Paul", category: 0, comments: [comments.first, comments.second])	